...
mens_parameters <- 
  data.frame(
    events = c("100", "200", "400", "1500", "110H", "HJ", "PV", "LJ", "SP", "DT", "JT", "55", "60", "1000", "55H", "60H"),
    a = c(25.4347, 5.8425, 1.53775, 0.03768, 5.74352, 0.8465, 0.2797, 0.14354, 51.39, 12.91, 10.14, 78.8196, 58.0150, 0.08713, 54.5278, 20.5173), 
    b = c(18, 38, 82, 480, 28.5, 75, 100, 220, 1.5, 4, 7, 10.75, 11.5, 305.5, 14.25, 15.5),
    c = c(1.81, 1.81, 1.81, 1.85, 1.92, 1.42, 1.35, 1.4, 1.05, 1.1, 1.08, 1.81, 1.81, 1.85, 1.92, 1.92)
  )
womens_parameters <- 
  data.frame(
    events = c("55", "200", "800", "100H", "HJ", "LJ", "SP", "JT", "100", "400", "1500", "PV", "DT", "55H", "60H"),
    a = c(66.2501, 4.99087, 0.11193, 9.23076, 1.84523, 0.188807, 56.0211, 15.9803, 17.8570, 1.34285, 0.02883, 0.44125, 12.3311, 28.7345, 20.0479), 
    b = c(12, 42.5, 254, 26.7, 75, 210, 1.5, 3.8, 21, 91.7, 535, 100, 3, 15.5, 17),
    c = c(1.81, 1.81, 1.88, 1.835, 1.348, 1.41, 1.05, 1.04, 1.81, 1.81, 1.88, 1.35, 1.1, 1.835, 1.835)
  )

field_events <- c("DT", "HJ", "JT", "LJ", "PV", "SP")
track_events <- c("55", "55H", "60", "60H", "100", "200", "400", "1500", "110H", "1000", "800", "100H")
